...
<body>
    ...
    <section class="item-banner" style="background-image: url(images/meat.jpg);">
        <div class="item-container">
            <h4>Fresh</h4>
            <h1 style="color: aliceblue;">Meats</h1>
        </div>
    </section>
    <!--Item Section Design-->
    <section class="items">
    ...
    <section class="footer">
        ...
        <div class="footer-content">
            <div class="footer-item">
                <p>ASP Marketing Services Pvt.Ltd<br>No.24/A,Union Place,Colombo 07</p>
